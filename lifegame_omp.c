...
// This is the original parallelized code that I used as the main reference for data
...
*/
  ...
  printf(" threads tot %d\nmult nxm = %dx%d for %d iter in %f seconds \n", omp_get_thread_num(), n,m, it-1, run_time);

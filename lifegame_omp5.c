...
// This code is for testing dyamica schedule for different chunk size
// you just write the dynamic clause near the for loop you want to dynamized
// The chunk size is defined at the start of the code as a constant that you can easily changed
...
//  printf ( "\n" );
  ...
  printf(" chunk = %d mult nxm = %dx%d for %d iter in %f s \n", CHUNK_SIZE, n,m, it-1, run_time);
